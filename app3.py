...
API_URL = "https://your-ai-api.com/generate"
...
centerframe.place(relx=0.5, rely=0.2, anchor="center")

checkframe = tk.Frame(root, bg="white")
checkframe.place(relx=0.5, rely=0.39, anchor="center")

generatebtnframe = tk.Frame(root, bg="white")
generatebtnframe.place(relx=0.5, rely=0.55, anchor="center")
...
image_label.pack(pady=15)  # Below upload button

# Remove button (Initially hidden)
remove_button = tk.Button(centerframe, text="Remove", command=remove_image, bg="red", fg="white", font=("Arial", 11))
remove_button.grid_forget()  # Initially hidden

# Image upload button
image_path = tk.StringVar()
tk.Button(centerframe, text="Upload Image", command=upload_image, bg="black", fg="white", font=("Arial", 11)).pack(pady=16)
